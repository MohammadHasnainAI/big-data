...
# -------------------------------------------------------------------------
    ...
    with col2:
        ...
        # Create a placeholder for the quote/result
        ...
        if analyze_btn:
            if user_input.strip():
                ...
                # --- SHOW QUOTE CARD (Using st.info so it is visible!) ---
                result_placeholder.info(f"💡 **Processing Big Data...**\n\n{selected_quote}")
                
                # Wait time to read quote
                ...
                # Clear the quote placeholder before showing result
