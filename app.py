...
with st.sidebar:
    ...
    # --- CUSTOM STUDENT CARD (Your HTML) ---
    st.markdown("""
    <div style="background-color: #e6f3ff; padding: 15px; border-radius: 10px; border-left: 5px solid #2196f3; box-shadow: 2px 2px 5px rgba(0,0,0,0.1);">
        <small style="color: #555;">Developed by:</small><br>
        <strong style="font-size: 16px; color: #333;">Mohammad Hasnain</strong><br>
        <span style="color: #666; font-size: 14px;">BS Artificial Intelligence</span>
    </div>
    """, unsafe_allow_html=True)
    
    # --- ACADEMIC SUPERVISION SECTION ---
    st.markdown("---")
    st.markdown("#### 🎓 Academic Supervision")
    st.write("**Supervisor:** Engr. Aneela Habib")
    st.caption("*Big Data Management & Processing*")
    st.markdown("---")
